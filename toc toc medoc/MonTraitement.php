...
$requeteUser= $bdd->prepare("SELECT * FROM mes_traitement WHERE idt=? AND id_medoc = (SELECT MAX(id_medoc) FROM mes_traitement)");
...
<html>
     ...
     <!-- header -->
		...
		<div id="traite">
			<h2 style="margin-top:40px; margin-left:10px;">Récapitulatif de mon traitement</h2>
			<table>
				<tr>
					<th>
						Nom du médicament
